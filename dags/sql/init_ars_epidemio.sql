...
CREATE TABLE IF NOT EXISTS rapports_ars (
    ...
    genere_le TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
...
('GRIPPE', 'Grippe', 'Syndrome grippal confirme ou probable', 5),
('GEA', 'Gastro-enterite aigue', 'Diarrhees et vomissements aigus', 3),
('SG', 'Syndrome grippal', 'Fievre + toux ou myalgies sans confirmation', 5),
('BRONCHIO', 'Bronchiolite', 'Bronchiolite du nourrisson (<2 ans)', 7),
('COVID19', 'Covid-19', 'Syndrome Covid-19 confirme ou probable', 7)
ON CONFLICT (code) DO NOTHING;

INSERT INTO departements (code_dept, nom, code_region, nom_region, population, chef_lieu) VALUES
('09', 'Ariege', '76', 'Occitanie', 153153, 'Foix'),
('11', 'Aude', '76', 'Occitanie', 375438, 'Carcassonne'),
('12', 'Aveyron', '76', 'Occitanie', 279594, 'Rodez'),
('30', 'Gard', '76', 'Occitanie', 750294, 'Nimes'),
('31', 'Haute-Garonne', '76', 'Occitanie', 1432680, 'Toulouse'),
('32', 'Gers', '76', 'Occitanie', 191283, 'Auch'),
('34', 'Herault', '76', 'Occitanie', 1175623, 'Montpellier'),
('46', 'Lot', '76', 'Occitanie', 174208, 'Cahors'),
('48', 'Lozere', '76', 'Occitanie', 76601, 'Mende'),
('65', 'Hautes-Pyrenees', '76', 'Occitanie', 228342, 'Tarbes'),
('66', 'Pyrenees-Orientales', '76', 'Occitanie', 479979, 'Perpignan'),
